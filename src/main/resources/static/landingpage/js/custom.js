...
$(window).ready(function() {
	...
	$.vegas('slideshow', {
	  backgrounds:[
		{ src:'landingpage/images/bg-slider/bg-1.jpg', fade:1000 },
		{ src:'landingpage/images/bg-slider/bg-2.jpg', fade:1000 },
		{ src:'landingpage/images/bg-slider/bg-3.jpg', fade:1000 }
	  ]
	})();
});
